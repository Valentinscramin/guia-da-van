...
trait AuthenticatesUsers
{
    ...
    {
        $response = file_get_contents('https://www.google.com/recaptcha/api/siteverify?secret=' . env('V2_SECRET_KEY') . '&response=' . $request->input('g-recaptcha-response') . '&remoteip=' . $_SERVER['REMOTE_ADDR']);

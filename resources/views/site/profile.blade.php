    ...
    <div class="container">
        <div class="row no-gutters">
            <div class="col-12 col-lg-6">
                <div class="bgUser" style="background: url(/storage/{{ $profile_photo }})no-repeat center center; backgrouns-size: cover; width: 100%; height: 45vh; border-radius: 40px;"></div>
            </div>

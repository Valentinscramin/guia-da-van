<form action="{{ route('busca_resultado') }}" method="POST">
    ...
    @endforeach
    <div class="btnSubmit col-12"><button type="submit" disabled><img src="{{URL('/images/lupa.svg')}}" alt=""> <img src="{{URL('/images/line.svg')}}" alt="" class="line"> Buscar Van</button></div>
</form>
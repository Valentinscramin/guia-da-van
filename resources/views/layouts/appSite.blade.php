                    ...
                    <div class="menu_mobile">
                        ...
                        <div class="content_menu">
                            <ul>
                                ...
                                <li><a href="{{ route('home') }}">Anuncie aqui</a></li>
                                ...
                                @else
                                <li class="button_account"><img src="{{ URL('/images/account.svg') }}" width=""> <a href="/user"> {{ Auth::user()->name }} </a>
                                </li>
                                @endguest
                            </ul>
                        </div>
                        ...
                        <div class="all_media col-10 col-md-7 col-lg-10">
                            ...
                            <div class="itemSocial col-12 col-lg-4">
                                ...
                                <div class="col-12 col-sm-8">
                                    ...
                                    <div class="description"><a href="#" target="_blank">Entre em contato
                                            conosco.</a>
                                    </div>
                                </div>
                            </div>
